...
export class InitialMigration1706232368640 implements MigrationInterface {
  name = 'InitialMigration1706232368640';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "games" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "total_kills" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "file_id" uuid, CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "players_games" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "score" integer NOT NULL DEFAULT '0', "player_id" uuid, "game_id" uuid, CONSTRAINT "PK_f6a5793108845e84a62ef672734" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "players_games" ADD CONSTRAINT "FK_fb9e6ff8c7118e9639cc4322226" FOREIGN KEY ("player_id") REFERENCES "players"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "players_games" ADD CONSTRAINT "FK_68a9682c92647e9bda6f27ea90b" FOREIGN KEY ("game_id") REFERENCES "games"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "players_games" DROP CONSTRAINT "FK_68a9682c92647e9bda6f27ea90b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "players_games" DROP CONSTRAINT "FK_fb9e6ff8c7118e9639cc4322226"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "players_games"`);
