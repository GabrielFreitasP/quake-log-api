export default () => ({
  ...
  database: {
    ...
    username: process.env.DATABASE_USERNAME || 'quakelogparser',
    password: process.env.DATABASE_PASSWORD || 'quakelogparser',
    name: process.env.DATABASE_NAME || 'quakelogparser',
